...
const /** {html element} */ $searchField = document.querySelector(
    "[data-search-field]"
  );
const /** {html element} */ $searchClear = document.querySelector(
    "[data-search-clear]"
  );
...
const activeSearchFilterItem = function () {
  document
    .querySelector("[data-search-filter].active")
    ?.classList.remove("active");
  this.classList.add("active");
};

$searchFilterItems &&
  addEventOnElems($searchFilterItems, "click", activeSearchFilterItem);
